...
class Youtube_Subs_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget']; //whatever you want to display before the widgets
		...
		echo $args['after_widget'];  //whatever you want to display after the widgets
	}
	...
	public function form( $instance ) {
		...
		$channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'UCrkjd6OmKAlb76N5hkQ4Wbw', 'yts_domain' );
